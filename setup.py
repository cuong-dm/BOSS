...
setup(
    ...
    entry_points={'console_scripts': (
        ...
        'gradient-ascent-BOSS=design_baselines.'
        'gradient_ascent_BOSS.experiments:cli',
        ...
        'gradient-ascent-min-ensemble-BOSS=design_baselines.'
        'gradient_ascent_BOSS.min_ensemble_experiments:cli',
        ...
        'gradient-ascent-mean-ensemble-BOSS=design_baselines.'
        'gradient_ascent_BOSS.mean_ensemble_experiments:cli',
        ...
        'mins-BOSS=design_baselines.'
        'mins_BOSS.experiments:cli',
        ...
        'cbas-BOSS=design_baselines.'
        'cbas_BOSS.experiments:cli',
        ...
        'autofocused-cbas-BOSS=design_baselines.'
        'autofocused_cbas_BOSS.experiments:cli',
        ...
        'cma-es-BOSS=design_baselines.'
        'cma_es_BOSS.experiments:cli',
        ...
        'bo-qei-BOSS=design_baselines.'
        'bo_qei_BOSS.experiments:cli',
        ...
        'reinforce-BOSS=design_baselines.'
        'reinforce_BOSS.experiments:cli',
