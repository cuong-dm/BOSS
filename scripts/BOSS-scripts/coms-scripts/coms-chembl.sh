...
for DEVICE in "${DEVICES[@]}"; do
    for TRIAL in $(seq $NUM_TRIALS_PER_GPU); do
        CUDA_VISIBLE_DEVICES=$DEVICE coms-BOSS \
            --logging-dir ./results/BOSS/coms-BOSS-chembl/coms-BOSS-chembl-$OE_LIMIT/COMs-BOSS-ChEMBL_MCHC_CHEMBL3885882_MorganFingerprint-RandomForest-v0-$DEVICE-$TRIAL-$RANDOM \
