...
from design_baselines.gradient_ascent_BOSS.trainers import MaximumLikelihood
from design_baselines.gradient_ascent_BOSS.trainers import Ensemble, VAETrainer
from design_baselines.gradient_ascent_BOSS.nets import ForwardModel, SequentialVAE, PhiGammaModel
...
def gradient_ascent_BOSS(config):
    ...
    for i, fm in enumerate(forward_models):
        ...
        trainer.launch( omega_mu_bound, 
                        ...
                        lr_omega,
                        alpha,
                        lambda_,train_data, validate_data, logger,
    ...
    for i in range(1, config['solver_steps'] + 1):
        ...
        solution = x
        hack[f'solution_step_{i}'] = solution.numpy()
