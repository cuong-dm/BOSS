...
from design_baselines.mins_BOSS.replay_buffer import ReplayBuffer
from design_baselines.mins_BOSS.trainers import Ensemble
from design_baselines.mins_BOSS.trainers import WeightedGAN
from design_baselines.mins_BOSS.nets import ForwardModel
from design_baselines.mins_BOSS.nets import Discriminator
from design_baselines.mins_BOSS.nets import DiscreteGenerator
from design_baselines.mins_BOSS.nets import ContinuousGenerator
from design_baselines.mins_BOSS.nets import ConvDiscriminator
from design_baselines.mins_BOSS.nets import DiscreteConvGenerator
from design_baselines.mins_BOSS.nets import ContinuousConvGenerator
from design_baselines.mins_BOSS.nets import PhiGammaModel
from design_baselines.mins_BOSS.utils import get_weights
from design_baselines.mins_BOSS.utils import get_synthetic_data
...
def mins_BOSS(config):
    """Optimize a design problem score using the algorithm MINS_BOSS
    ...
    if config['offline']:
        ...
        oracle = Ensemble(phi_gamma_model,
                          omega_0,
                          forward_models,
